...
<dt class="deftypefn def-line" id="index-readRecord_0028file_002c"><span class="category-def">: </span><span><code class="def-type"><var class="var">rec</var> =</code> <strong class="def-name">readRecord(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">recidx</var>)</code><a class="copiable-link" href="#index-readRecord_0028file_002c"></a></span></dt>
