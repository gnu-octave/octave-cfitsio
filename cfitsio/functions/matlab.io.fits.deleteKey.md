...
<dt class="deftypefn def-line" id="index-deleteKey_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">deleteKey(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">key</var>)</code><a class="copiable-link" href="#index-deleteKey_0028file_002c"></a></span></dt>
