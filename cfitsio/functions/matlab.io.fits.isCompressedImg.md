...
<dt class="deftypefn def-line" id="index-isCompressedImg_0028file_0029"><span class="category-def">: </span><span><code class="def-type"><var class="var">comp</var> =</code> <strong class="def-name">isCompressedImg(<var class="var">file</var>)</strong><a class="copiable-link" href="#index-isCompressedImg_0028file_0029"></a></span></dt>
