...
<dt class="deftypefn def-line" id="index-writeComment_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">writeComment(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">comment</var>)</code><a class="copiable-link" href="#index-writeComment_0028file_002c"></a></span></dt>
