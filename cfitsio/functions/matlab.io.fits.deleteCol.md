...
<dt class="deftypefn def-line" id="index-deleteCol_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">deleteCol(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">colnum</var>)</code><a class="copiable-link" href="#index-deleteCol_0028file_002c"></a></span></dt>
