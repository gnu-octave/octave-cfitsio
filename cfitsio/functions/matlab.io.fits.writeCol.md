...
<dt class="deftypefn def-line" id="index-writeCol_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">writeCol(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">colnum</var>, <var class="var">firstrow</var>, <var class="var">data</var>)</code><a class="copiable-link" href="#index-writeCol_0028file_002c"></a></span></dt>
