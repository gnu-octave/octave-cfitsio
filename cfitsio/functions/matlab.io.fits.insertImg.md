...
<dt class="deftypefn def-line" id="index-insertImg_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">insertImg(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">bitpix</var>, <var class="var">naxis</var>)</code><a class="copiable-link" href="#index-insertImg_0028file_002c"></a></span></dt>
