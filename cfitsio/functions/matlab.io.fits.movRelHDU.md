...
<dt class="deftypefn def-line" id="index-_003d"><span><code class="def-type"><var class="var">type</var></code> <strong class="def-name">=</strong> <code class="def-code-arguments">movRelHDU(<var class="var">file</var>, <var class="var">hdunum</var>)</code></span></dt>
