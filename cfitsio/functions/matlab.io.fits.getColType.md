...
<dt class="deftypefn def-line" id="index-_003d"><span><code class="def-type">[<var class="var">dtype</var>,<var class="var">repeat</var>,<var class="var">width</var>]</code> <strong class="def-name">=</strong> <code class="def-code-arguments">getColType(<var class="var">file</var>, <var class="var">colnum</var>)</code></span></dt>
