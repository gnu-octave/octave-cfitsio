...
<dt class="deftypefn def-line" id="index-setHCompSmooth_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">setHCompSmooth(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">smooth</var>)</code><a class="copiable-link" href="#index-setHCompSmooth_0028file_002c"></a></span></dt>
