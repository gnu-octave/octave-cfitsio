...
<dt class="deftypefn def-line" id="index-getHdrSpace_0028file_0029"><span class="category-def">: </span><span><code class="def-type">[<var class="var">numkeys</var>, <var class="var">freekeys</var>] =</code> <strong class="def-name">getHdrSpace(<var class="var">file</var>)</strong><a class="copiable-link" href="#index-getHdrSpace_0028file_0029"></a></span></dt>
