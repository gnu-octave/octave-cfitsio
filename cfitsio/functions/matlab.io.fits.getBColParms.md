...
<dt class="deftypefn def-line" id="index-_003d"><span class="category-def">: </span><span><code class="def-type">[<var class="var">ttype</var>,<var class="var">tunit</var>,<var class="var">typechar</var>,<var class="var">repeat</var>,<var class="var">scale</var>,<var class="var">zero</var>,<var class="var">nulval</var>,<var class="var">tdisp</var>]</code> <strong class="def-name">=</strong> <code class="def-code-arguments">getBColParms(<var class="var">file</var>, <var class="var">colnum</var>)</code><a class="copiable-link" href="#index-_003d"></a></span></dt>
