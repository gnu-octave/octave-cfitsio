...
<dt class="deftypefn def-line" id="index-insertRows_0028file_002c"><span class="category-def">: </span><span><strong class="def-name">insertRows(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">firstrow</var>, <var class="var">numrows</var>)</code><a class="copiable-link" href="#index-insertRows_0028file_002c"></a></span></dt>
