...
<dt class="deftypefn def-line" id="index-readKeyUnit_0028file_002c"><span class="category-def">: </span><span><code class="def-type"><var class="var">keyunit</var> =</code> <strong class="def-name">readKeyUnit(<var class="var">file</var>,</strong> <code class="def-code-arguments"><var class="var">recname</var>)</code><a class="copiable-link" href="#index-readKeyUnit_0028file_002c"></a></span></dt>
