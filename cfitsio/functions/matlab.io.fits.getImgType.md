...
<dt class="deftypefn def-line" id="index-_003d"><span><code class="def-type"><var class="var">type</var></code> <strong class="def-name">=</strong> <code class="def-code-arguments">getImgType(<var class="var">file</var>)</code></span></dt>
